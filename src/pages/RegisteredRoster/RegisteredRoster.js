...
const handleExportPDF = (currentCountry = "All", currentCenter = "All", currentMandal = "All", generatedByName = "Admin") => {
  ...
  autoTable(doc, {
    ...
    didDrawPage: function (data) {
      ...
      // Dynamic footer displaying pagination and generator identity
      doc.text(
      ...
      doc.text(
        `Report generated by: ${generatedByName}`,
        doc.internal.pageSize.width - data.settings.margin.right - doc.getTextWidth(`Report generated by: ${generatedByName}`),
        doc.internal.pageSize.height - 10
      );
    }
  });
