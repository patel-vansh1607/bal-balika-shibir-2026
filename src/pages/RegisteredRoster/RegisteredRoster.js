...
const handleExportPDF = (
  ...
  autoTable(doc, {
    ...
    didDrawPage: function (data) {
      ...
      // Dynamic footer showing system role name cleanly aligned to the right edge
      const footerString = `System report generated by: ${generatedByName}`;
      const textWidth = doc.getTextWidth(footerString);
      const rightXPosition = doc.internal.pageSize.width - data.settings.margin.right - textWidth;
