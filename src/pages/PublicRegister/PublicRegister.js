                ...
                <div className={styles.formGrid}>
                  ...
                  <div className={styles.rowFieldContainer}>
                    <div className={styles.formGroup} ref={ageRef}>
                      ...
                      <input type="number" required min="9" max="14" className={`${styles.input} ${formError && !age ? styles.inputError : ""}`} placeholder="e.g. 11" value={age} onChange={(e) => setAge(e.target.value)} disabled={loading} />
                    </div>
