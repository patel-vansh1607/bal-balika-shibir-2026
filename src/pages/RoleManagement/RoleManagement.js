  ...
  if (globalLoading)
    return (
      <div className={styles.centerPad}>
        <FaSpinner className={styles.spin} /> Loading Credentials...
      </div>
    );
    ...
    <div className={styles.managementPanelCard}>
      <div className={styles.panelHeader}>
        ...
        <div>
          ...
          <p>
            Mutate environment permission scopes and manage gate operator
            privilege tiers.
          </p>
        </div>
      </div>
            ...
            <tr key={account.id}>
              ...
              <td>
                <select
                  ...
                  onChange={(e) =>
                    handleRoleMutation(account.id, e.target.value)
                  }
                >
                ...
                {updatingId === account.id && (
                  <FaSpinner
                    className={`${styles.spin} ${styles.inlineLoader}`}
                  />
                )}
              </td>
            </tr>
