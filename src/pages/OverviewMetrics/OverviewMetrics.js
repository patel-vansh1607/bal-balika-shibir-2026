    ...
    <>
      ...
      <section className={styles.statsGrid}>
        ...
        <div className={styles.statCard}>
          ...
          <p className={styles.statValue} style={{ color: 'var(--accent-primary)' }}>
            {totalCheckedIn}
          </p>
        </div>
      ...
      {/* Stream Logs Card Block */}
      <section className={styles.contentCard}>
        <div className={styles.cardHeader}>
          <h3 className={styles.cardTitle}>
            <FaClipboardList style={{ marginRight: '8px', color: 'var(--accent-primary)' }} /> 
                ...
                <tr key={a.id}>
                  ...
                  <td>
                    <span className={styles.badgePresent}>
                      <FaCheckCircle style={{ marginRight: '4px', fontSize: '11px' }} /> {a.status}
                    </span>
                  </td>
